...
- เมื่อลบสถานที่ออก จะทำการ check out ทุกคนออกจากสถานที่นั้นด้วย ทำให้คนไม่ค้างอยู่ในสถานที่นั้นๆ
- ในการแก้ไขปัญหานี้ เขียนโค้ดโดยคำนึงถึง time complexity เป็นหลัก ทำให้สามารถประมวลผลได้เร็วเมื่อมีผู้ใช้งานจำนวนมาก
- โปรแกรมออกแบบมาให้สามารถเพิ่มการเก็บข้อมูลอื่น ๆ ของผู้ใช้ได้โดยง่าย (เช่น ชื่อ นามสกุล) โดยการเพิ่มตัวแปรลงใน class `Person`
